...
const styles = StyleSheet.create({
  ...
  headerTitulo: { fontSize: TYPOGRAPHY.size.xxl, fontWeight: '700', color: COLORS.textPrimary },
  filtrosContainer: {
  ...
  filtroBotao: {
    ...
    borderRadius: BORDER_RADIUS.full, backgroundColor: COLORS.surfaceSoft,
  },
  filtroBotaoAtivo: { backgroundColor: COLORS.primary },
  filtroTexto: { fontSize: TYPOGRAPHY.size.sm, fontWeight: '600', color: COLORS.textSecondary },
  filtroTextoAtivo: { color: '#FFFFFF' },
  lista: { flex: 1, paddingHorizontal: SPACING.lg, paddingTop: SPACING.md },
  secaoLabel: {
    fontSize: TYPOGRAPHY.size.xs, fontWeight: '700', color: COLORS.textTertiary,
    letterSpacing: 1, marginTop: SPACING.md, marginBottom: SPACING.sm,
  },
  card: {
    flexDirection: 'row', alignItems: 'center', backgroundColor: COLORS.surface,
    borderRadius: BORDER_RADIUS.md, marginBottom: SPACING.md, overflow: 'hidden',
    shadowColor: '#000', shadowOffset: { width: 0, height: 1 },
    shadowOpacity: 0.07, shadowRadius: 4, elevation: 2,
  },
  cardNaoResolvido: { borderWidth: 1, borderColor: '#FFCDD2' },
  barraLateral: { width: 4, alignSelf: 'stretch' },
  iconeWrapper: {
    width: 40, height: 40, borderRadius: 20,
    justifyContent: 'center', alignItems: 'center',
    margin: SPACING.md, marginRight: SPACING.sm,
  },
  conteudo: { flex: 1, paddingVertical: SPACING.md, paddingRight: SPACING.sm },
  linhaTop: {
    flexDirection: 'row', justifyContent: 'space-between',
    alignItems: 'flex-start', marginBottom: 3,
  },
  titulo: {
    flex: 1, fontSize: TYPOGRAPHY.size.md, fontWeight: '700',
    color: COLORS.textPrimary, marginRight: SPACING.sm,
  },
  tituloLido: { fontWeight: '500', color: COLORS.textSecondary },
  hora: { fontSize: TYPOGRAPHY.size.xs, color: COLORS.textTertiary, marginTop: 2 },
  descricao: { fontSize: TYPOGRAPHY.size.sm, color: COLORS.textSecondary, lineHeight: 18 },
  descricaoLida: { color: COLORS.textTertiary },
  badgeNaoResolvido: {
    alignSelf: 'flex-start', backgroundColor: '#FFEBEE',
    borderRadius: BORDER_RADIUS.full, paddingHorizontal: SPACING.sm,
    paddingVertical: 2, marginTop: SPACING.xs,
  },
  badgeTexto: { fontSize: TYPOGRAPHY.size.xs, fontWeight: '600', color: '#E53935' },
  seta: { paddingHorizontal: SPACING.md },
  ...
  vazioSubtitulo: { fontSize: TYPOGRAPHY.size.sm, color: COLORS.textSecondary, marginTop: SPACING.xs },
});
